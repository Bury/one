	...
	<div class="remind-list-page">
		<div class="top-box">
			<el-form :inline="true" :model="requestParameters" class="demo-form-inline" size="mini">
				...
				<el-form-item label="进店时间：">
					<el-date-picker v-model="value4" type="datetimerange" range-separator="至" start-placeholder="开始时间" end-placeholder="结束时间">
					</el-date-picker>
				</el-form-item>
		...
		<el-table :data="tableData" border height="380" style="margin:0 auto;width: 1551px;text-align:center;">
			...
			<el-table-column fixed="right" label="操作" width="150">
				<template slot-scope="scope">
					<el-button type="text" size="small" v-if="avatarFormVisible" @click="getAvatar(scope.row)">关联</el-button>
